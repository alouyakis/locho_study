...
# ggplot2::ggsave("plots/clustering/clusters_p0.05.png", height = 8, width = 14, create.dir = TRUE)
ggplot2::ggsave("plots/clustering/clusters_p1.0.png", height = 8, width = 14, create.dir = TRUE)
...
lapply(names(dfs),
       # function(x){write.csv(dfs[[x]], paste0("tables/cluster_kegg_p0.05_", x,".csv"),
       function(x){write.csv(dfs[[x]], paste0("tables/cluster_kegg_p1.0_", x,".csv"),
                             row.names = FALSE)})
```
